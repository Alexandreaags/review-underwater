...
%*-------------------------------------------------------------------------------
\title              {AUVs}
\subtitle           {Review Paper}
\author             {Alexandre Adonai e Thâmara Lins}
\email              {alexandre.adonai2002@hotmail.com, thamaralins01@gmail.com}
...
\begin{frame}[c,plain]
    \lastpage{
        \begin{center}   
            ...
            %\hspace{1.5cm} 
            alexandre.adonai2002@hotmail.com
